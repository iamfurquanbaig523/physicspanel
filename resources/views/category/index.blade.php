                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-borderless table-striped" aria-describedby="mydesc"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="series_title" data-sortable="true">{{ __('Frontend Series Title') }}</th>
                                <th scope="col" data-field="image" data-align="center" data-formatter="imageFormatter">{{ __('Image') }}</th>
                                <th scope="col" data-field="articles_count" data-align="center" data-sortable="false">{{ __('Articles') }}</th>
                                <th scope="col" data-field="header_nav" data-align="center" data-sortable="false">{{ __('Header Nav') }}</th>
                                <th scope="col" data-field="mobile_nav" data-align="center" data-sortable="false">{{ __('Mobile Nav') }}</th>
