                    ...
                    <div class="card-body">
                        <table class="table table-borderless table-striped translatable-table" aria-describedby="mydesc"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="author" data-align="center">{{ __('Author') }}</th>
                                ...
                                <th scope="col" data-field="read_time" data-align="center">{{ __('Read Time') }}</th>
                                <th scope="col" data-field="status" data-align="center" data-sortable="true">{{ __('Status') }}</th>
                                <th scope="col" data-field="is_featured" data-align="center" data-sortable="true">{{ __('Featured') }}</th>
                                <th scope="col" data-field="published_at" data-align="center" data-sortable="true">{{ __('Published') }}</th>
