...
class DefaultSettingService {
    ...
    public static function get() {
        ...
        return [
            ...
            ['name' => 'company_email', 'value' => 'hello@searchenginebasics.io', 'type' => 'string'],
            ['name' => 'company_name', 'value' => 'Search Engine Basics', 'type' => 'string'],
            ['name' => 'website_url', 'value' => 'https://searchenginebasics.io', 'type' => 'string'],
            ...
            ['name' => 'mail_from_address', 'value' => 'hello@searchenginebasics.io', 'type' => 'string'],
            ['name' => 'depp_link_scheme', 'value' => 'searchenginebasics', 'type' => 'string'],
