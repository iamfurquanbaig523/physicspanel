...
class DefaultSettingService {
    ...
    public static function get() {
        ...
        return [
            ...
            ['name' => 'company_email', 'value' => 'hello@physicsfundamental.org', 'type' => 'string'],
            ['name' => 'company_name', 'value' => 'Physics Fundamentals', 'type' => 'string'],
            ['name' => 'website_url', 'value' => 'https://physicsfundamental.org', 'type' => 'string'],
            ...
            ['name' => 'mail_from_address', 'value' => 'hello@physicsfundamental.org', 'type' => 'string'],
            ['name' => 'depp_link_scheme', 'value' => 'physicsfundamental', 'type' => 'string'],
